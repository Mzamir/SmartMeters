package zamir.com.smartmeters.services;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void handleNotification(String message) {
        saveNotificationsToDatabase(message);
    ...
    private void saveNotificationsToDatabase(String message) {
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        String key = database.getReference(Config.SHARED_NOTIFICATIONS)
