package zamir.com.smartmeters.utils;
...
public class NotificationUtils {
    ...
    public void showNotificationMessage(final String title, final String message, final String timeStamp, Intent intent, String imageUrl) {
        ...
        final android.support.v4.app.NotificationCompat.Builder mBuilder = new android.support.v4.app.NotificationCompat.Builder(
                mContext);
...
//            setNotificationMessageToSharedPrefence(message);
//            addNotificationToData(message);
    ...
    private void showBigNotification(Bitmap bitmap, android.support.v4.app.NotificationCompat.Builder mBuilder, int icon, String title, String message, String timeStamp, PendingIntent resultPendingIntent, Uri alarmSound) {
    ...
    private void setNotificationMessageToSharedPrefence(String message) {
        ...
        editor.putString(Config.SHARED_NOTIFICATIONS_MESSAGE, message);
        editor.commit();
    }
